...
function deleteproduct(){
  $postid = document.getElementsByName['postIDbox'][0].value;
  ...
  xmlhttp.open("GET", "../addProduct/deletefrommyproduct.php?pid="+$postid, true);
  xmlhttp.send();

}

//add to product modal end
